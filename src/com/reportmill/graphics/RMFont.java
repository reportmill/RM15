...
public class RMFont extends Font {
     ...
     */
    protected RMFont(FontFile aFontFile, double aSize)
    {
        super(aFontFile, aSize);
    }

    /**
     * Returns the font for the given name and size (substitutes Arial if not found).
     */
    public static RMFont getFont(String aName, double aSize)
    {
        return new RMFont(aName, aSize);
    }
