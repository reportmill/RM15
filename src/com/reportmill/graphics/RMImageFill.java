...
public class RMImageFill extends RMFill {
    ...
    {
        return _iref != null ? _iref.getImage() : null;
    }
    ...
    {
        return isAbsolute() ? getWidth() / getImage().getWidth() : getWidth();
    }
    ...
    {
        return isAbsolute() ? getHeight() / getImage().getHeight() : getHeight();
    }
    ...
    public RMImageFill copyFor(Rect aRect, boolean isAbs)
    {
        ...
        copy._snap = _snap.copyForRectAndTile(aRect, isAbs);
        return copy;
    }
    ...
    public boolean equals(Object anObj)
    {
        ...
        RMImageFill other = anObj instanceof RMImageFill ? (RMImageFill) anObj : null;
