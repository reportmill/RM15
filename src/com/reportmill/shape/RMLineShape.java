...
public class RMLineShape extends RMParentShape {
    ...
    {
        return getChildCount() == 0 ? null : (ArrowHead) getChild(0);
    }
    ...
    public static class ArrowHead extends RMPolygonShape {
        ...
        {
            return _originInPath;
        }

        /**
         * Returns the line origin in parent.
         */
        public Point getOriginInParent()
        {
            return localToParent(_originInShape);
        }

        /**
         * Override to trigger line relayout.
         */
        public void setScaleX(double aVal)
        {
            super.setScaleX(aVal);
            if (getParent() != null) getParent().relayout();
        }

        public void setScaleY(double aVal)
        {
            super.setScaleY(aVal);
            if (getParent() != null) getParent().relayout();
        }
        ...
        protected void fromXMLShape(XMLArchiver anArchiver, XMLElement anElement)
        {
            ...
            _originInShape = Transform.getTransformBetweenRects(_path.getBounds(), getBoundsInside()).transformXY(x, y);
        }
    }
