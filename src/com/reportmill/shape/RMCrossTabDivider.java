...
public class RMCrossTabDivider extends RMLineShape {
     ...
     */
    public RMCrossTabDivider(RMCrossTabSpan aSpan)
    {
        _span = aSpan;
    }
    ...
    {
        return _span instanceof RMCrossTabRow;
    }

    /**
     * Returns whether divider is a column divider.
     */
    public boolean isColDivider()
    {
        return _span instanceof RMCrossTabCol;
    }
    ...
    {
        return (RMCrossTabRow) _span;
    }

    /**
     * Returns the divider column as cell column.
     */
    public RMCrossTabCol getCol()
    {
        return (RMCrossTabCol) _span;
    }
    ...
    {
        return isRowDivider() ? getRow()._table : getCol()._table;
    }
