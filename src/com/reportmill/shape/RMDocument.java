...
{
    try { setPageLayout(PageLayout.valueOf(StringUtils.firstCharUpperCase(aValue))); }
...
{
    try { setUnit(SnapUtils.valueOfIC(Unit.class, aString)); }
 ...
 */
public byte[] getBytesPDF()  { return new com.reportmill.out.RMPDFWriter().getBytes(this); }
