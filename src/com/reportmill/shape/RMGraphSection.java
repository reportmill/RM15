...
public class RMGraphSection {
    ...
    public Rect getBounds()
    {
        ...
        if (_graph.isVertical()) {
            w /= _graphRPG.getSectionCount();
            x += _index * w;
        } else {
            h /= _graphRPG.getSectionCount();
            y += _index * h;
        }
    ...
    public static List getSections(RMGraphRPG aGraphRPG)
    {
        ...
        if (aGraphRPG.getSeriesCount() == 0) return sections;
        ...
        // Handle Separated
            ...
            for (int i = 0, iMax = aGraphRPG.getSeriesCount(); i < iMax; i++) {
                RMGraphSeries series = aGraphRPG.getSeries(i);
                RMGraphSection section = new RMGraphSection(aGraphRPG, i);
    ...
    public class Item {
        ...
        {
            return _graphRPG.getSeries(_seriesIndex);
        }
        ...
        {
            return getSeries().getItem(_itemIndex);
        }
        ...
        {
            return getSeriesItem().getFloatValue();
        }
