...
public class RMCrossTabSpan implements Cloneable {
    ...
    {
        return getDividers().get(anIndex);
    }
    ...
    public RMCrossTabSpan clone()
    {
        ...
        try {
            clone = (RMCrossTabSpan) super.clone();
