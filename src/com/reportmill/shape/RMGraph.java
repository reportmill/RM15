...
public class RMGraph extends RMParentShape {
    ...
    {
        return rpgAll(anRptOwner, aParent, false);
    }
    ...
    {
        return useProxy() ? _proxyShape.getStroke() : super.getStroke();
    }
    ...
    protected void fromXMLShape(XMLArchiver anArchiver, XMLElement anElement)
    {
        ...
        if (gxml != null) {
            ...
            if (anElement.getElements("grouping").size() > 1)
                System.err.println("RMGraph.fromXML: Multiple groups not read");
        }
        ...
        // Unarchive series
        for (int i = anElement.indexOf("series"); i >= 0; i = anElement.indexOf("series", i + 1)) {
            XMLElement sxml = anElement.get(i);
    ...
    public RMShape fromXML(XMLArchiver anArchiver, XMLElement anElement)
    {
        ...
        RMParentShape frameShape = new RMParentShape();
        frameShape.fromXML(anArchiver, anElement);
