...
public class RMSwitchShape extends RMParentShape {
    ...
    public void setVersion(String aName)
    {
        ...
        if (inShape == null) {
            ...
            inShape._alternates = null;
            inShape._version = aName;
        }
    ...
    {
        return getVersion(aString) != null;
    }
    ...
    public RMSwitchShape cloneDeep()
    {
        ...
        RMSwitchShape clone = (RMSwitchShape) super.cloneDeep();
        if (getAlternates() == null) return clone;
