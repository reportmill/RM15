...
public class RMShapePaintProps extends Painter.Props {
     ...
     */
    public static boolean isEditing(Painter aPntr)
    {
        return get(aPntr).isEditing();
    }

    /**
     * Returns whether given shape is selected.
     */
    public static boolean isSelected(Painter aPntr, RMShape aShape)
    {
        return get(aPntr).isSelected(aShape);
    }

    /**
     * Returns whether given shape is super selected.
     */
    public static boolean isSuperSelected(Painter aPntr, RMShape aShape)
    {
        return get(aPntr).isSuperSelected(aShape);
    }
