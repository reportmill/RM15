 ...
 */
public static RMShapeTable createTable(List <RMShape> shapes, RMShape topLevel, Rect minTableRect)
{
 ...
 */
static void fillInCells(STCell cells[][], double rowStarts[], double colStarts[], Rect maxBounds)
{
    // Iterate over cells
