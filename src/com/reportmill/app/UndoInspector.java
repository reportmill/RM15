...
public class UndoInspector extends RMEditorPane.SupportPane {
     ...
     */
    public UndoInspector(RMEditorPane anEP)
    {
        super(anEP);
    }
    ...
    public void respondUI(ViewEvent anEvent)
    {
        ...
        if (anEvent.equals("UndosList")) {
            ...
            int index = getViewItems("UndosList").size() - 1 - getViewSelIndex("UndosList");
            if (index < 0) return;
        ...
        if (anEvent.equals("RedosList")) {
            ...
            // Get selected index (just return if null)
            int index = getViewItems("RedosList").size() - 1 - getViewSelIndex("UndosList");
            if (index < 0) return;
