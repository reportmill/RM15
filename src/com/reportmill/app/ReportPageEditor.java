...
public class ReportPageEditor extends ReportPage {
    ...
    protected View createUI()
    {
        ...
        ebtn.setText("Edit");
        ebtn.setName("EditButton");
        ebtn.setPrefWidth(100);
        Button tbtn = new Button();
        tbtn.setText("Text");
        tbtn.setName("TextButton");
        tbtn.setPrefWidth(100);
        RowView hbox = new RowView();
        hbox.setAlign(Pos.CENTER_RIGHT);
        hbox.setPadding(3, 3, 3, 3);
        hbox.setSpacing(5);
        hbox.addChild(ebtn);
        hbox.addChild(tbtn);
