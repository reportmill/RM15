...
public class RMViewerShape extends RMParentShape {
    ...
    {
        RMDocument d = getDoc();
        return d != null ? d.getPrefWidth() : 0;
    }
    ...
    {
        RMDocument d = getDoc();
        return d != null ? d.getPrefHeight() : 0;
    }
    ...
    protected void layoutImpl()
    {
        ...
        if (doc.getScaleX() != _viewer.getZoomFactor()) {
            double sc = _viewer.getZoomFactor();
