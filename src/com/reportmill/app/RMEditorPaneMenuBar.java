...
public class RMEditorPaneMenuBar extends RMEditorPane.SupportPane {
     ...
     */
    public RMEditorPaneMenuBar(RMEditorPane anEP)
    {
        super(anEP);
    }
    ...
    protected void respondUI(ViewEvent anEvent)
    {
        ...
        if (anEvent.equals("HollywoodMenuItem"))
            RMEditorPaneUtils.openSample("Jar:/com/reportmill/examples/HollywoodDB.xml");
        ...
        if (name.equals("MakePolygonShapeMenuItem")) RMEditorUtils.makePolygonShape(editor);
