...
public class DataSourcePanel extends RMEditorPane.SupportPane {
     ...
     */
    public DataSourcePanel(RMEditorPane anEP)
    {
        super(anEP);
    }
    ...
    public void respondUI(ViewEvent anEvent)
    {
        ...
        if (anEvent.equals("EntitiesList")) {
            _selectedEntityIndex = anEvent.getSelIndex();
        ...
        if (anEvent.equals("TypeComboBox")) {
            getSelProperty().setType(unprettyType(anEvent.getStringValue()));
            ds.setCustomSchema(true);
        }
        if (anEvent.equals("SubtypeComboBox")) {
            getSelProperty().setRelationEntityName(anEvent.getStringValue());
            ds.setCustomSchema(true);
        }

        // Handle PrimaryCheckBox
        if (anEvent.equals("PrimaryCheckBox")) {
            getSelProperty().setPrimary(anEvent.getBooleanValue());
            ds.setCustomSchema(true);
        }
    }
