...
public class RMViewer extends ParentView {
    ...
    {
        return getShapeAtPoint(new Point(aX, aY), goDeep);
    }
    ...
    public RMShape getShapeAtPoint(Point aPoint, boolean goDeep)
    {
        ...
        RMShape shape = null;
        Point point2 = null;
        for (int i = parent.getChildCount(); i > 0 && shape == null; i--) {
            RMShape child = parent.getChild(i - 1);
    ...
    {
        RMShapePaintProps props = createShapePaintProps();
        if (props != null) aPntr.setProps(props);
     ...
     */
    public RMViewerEvents getEvents()
    {
        return _events;
    }
     ...
     */
    protected RMViewerEvents createEvents()
    {
        return new RMViewerEvents(this);
    }
    ...
    private class RMVPrintable implements Printer.Printable {
        ...
        {
            return RMViewer.this.getPageCount();
        }
