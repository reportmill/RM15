...
public class RMEditorEvents extends RMViewerEvents {
     ...
     */
    public RMEditorEvents(RMViewer aViewer)
    {
        super(aViewer);
    }
     ...
     */
    public Point getEventPointInShape(boolean snapToGrid)
    {
        return getEventPointInShape(snapToGrid, false);
    }
    ...
    private Point pointSnappedToGrid(Point aPoint, boolean snapEdges)
    {
        ...
        // If SnapEdges, find dx/dy for all edges of selected shapes to nearest grid or guide
            ...
            for (int i = 0, iMax = editor.getSelectedShapeCount(); i < iMax; i++) {
                RMShape shape = editor.getSelectedShape(i);
