...
public class RMNumberFormat implements RMFormat, Cloneable {
    ...
    {
        return _fmt.isGroupingUsed() ? "" + _fmtSyms.getGroupingSeparator() : null;
    }
    ...
    {
        return "" + _fmtSyms.getDecimalSeparator();
    }
    ...
    {
        return _fmt.getMinimumFractionDigits();
    }
    ...
    {
        _fmt.setMinimumFractionDigits(aVal);
    }
    ...
    {
        return _fmt.getMaximumFractionDigits();
    }
    ...
    {
        _fmt.setMaximumFractionDigits(aVal);
    }
    ...
    public void setPattern(String aFormat)
    {
        ...
        for (int i = length - 1; i > 1; i--) {
            char c1 = format.charAt(i), c2 = format.charAt(i - 1), c3 = format.charAt(i - 2);
        ...
        // If that failed, re-throw exception
            ...
            throw new IllegalArgumentException("Malformed format string \"" + aFormat + "\"");
        }
    }
    ...
    private Number getNumber(Object anObj)
    {
        ...
        Number num = anObj instanceof Number ? (Number) anObj : null;
        ...
        String str = _fmt.getPositiveSuffix();
        if (str == null) str = ""; // For TeaVM
        if (str.indexOf('%') >= 0)
