...
public class Property implements Comparable<Object>, XMLArchiver.Archivable {
     ...
     */
    public Property(String aName, Type aType)
    {
        setName(aName);
        setType(aType);
    }
    ...
    {
        return Key.getStandard(getName());
    }
    ...
    {
        return getType() != Type.Relation && getType() != Type.RelationList;
    }
    ...
    {
        return getType() == Type.RelationList;
    }
    ...
    {
        setType(aValue ? Type.RelationList : Type.Relation);
    }
    ...
    public boolean equals(Object anObj)
    {
        ...
        Property other = anObj instanceof Property ? (Property) anObj : null;
