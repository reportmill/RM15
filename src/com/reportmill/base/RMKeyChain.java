...
public class RMKeyChain {
    ...
    static ThreadLocal<Map> _assTL = new ThreadLocal() {
    ...
    {
        RMKeyChain kc = new RMKeyChain();
        kc._op = getRM(aKC.getOp());
        for (int i = 0; i < aKC.getChildCount(); i++) {
            Object child = aKC.getChild(i);
    ...
    private static RMKeyChain.Op getRM(KeyChain.Op anOp)
    {
        switch (anOp) {
            case Literal:
                return RMKeyChain.Op.Literal;
            case Add:
                return RMKeyChain.Op.Add;
            case Subtract:
                return RMKeyChain.Op.Subtract;
            case Multiply:
                return RMKeyChain.Op.Multiply;
            case Divide:
                return RMKeyChain.Op.Divide;
            case Mod:
                return RMKeyChain.Op.Mod;
            case Negate:
                return RMKeyChain.Op.Negate;
            case Equal:
                return RMKeyChain.Op.Equal;
            case NotEqual:
                return RMKeyChain.Op.NotEqual;
            case GreaterThan:
                return RMKeyChain.Op.GreaterThan;
            case LessThan:
                return RMKeyChain.Op.LessThan;
            case GreaterThanOrEqual:
                return RMKeyChain.Op.GreaterThanOrEqual;
            case LessThanOrEqual:
                return RMKeyChain.Op.LessThanOrEqual;
            case And:
                return RMKeyChain.Op.And;
            case Or:
                return RMKeyChain.Op.Or;
            case Not:
                return RMKeyChain.Op.Not;
            case Key:
                return RMKeyChain.Op.Key;
            case ArrayIndex:
                return RMKeyChain.Op.ArrayIndex;
            case FunctionCall:
                return RMKeyChain.Op.FunctionCall;
            case ArgList:
                return RMKeyChain.Op.ArgList;
            case Chain:
                return RMKeyChain.Op.Chain;
            case Conditional:
                return RMKeyChain.Op.Conditional;
            case Assignment:
                return RMKeyChain.Op.Assignment;
            default:
                throw new RuntimeException("RMKeyChain.getRM(op): Unsupported op: " + anOp);
        }
    }
    ...
    public RMKeyChain subchain(int anIndex)
    {
        ...
        if (anIndex + 1 == ccount) return getChildKeyChain(anIndex);
        RMKeyChain kc = new RMKeyChain(Op.Chain);
        for (int i = anIndex; i < ccount; i++) kc.addChild(getChild(i));
        return kc;
    }
    ...
    {
        return getValue(anObj, getKeyChain(aKeyChain));
    }

    /**
     * Returns the result of evaluating the given key chain on the given object.
     */
    public static Object getValue(Object anObj, RMKeyChain aKeyChain)
    {
    ...
    public static Object getValueImpl(Object aRoot, Object anObj, RMKeyChain aKeyChain)
    {
        ...
        switch (aKeyChain.getOp()) {
            ...
            default:
                throw new RuntimeException("RMKeyChain.getValueImpl: Invalid op " + aKeyChain.getOp());
        }
    }
    ...
    private static Object getValueBinaryMathOp(Object aRoot, Object anObj, RMKeyChain aKeyChain)
    {
        ...
        switch (aKeyChain.getOp()) {
            case Add:
                return add(o1, o2);
            case Subtract:
                return MathUtils.subtract((Number) o1, (Number) o2);
            case Multiply:
                return MathUtils.multiply((Number) o1, (Number) o2);
            case Divide:
    ...
    private static Object add(Object obj1, Object obj2)
    {
        ...
        if (obj1 instanceof String || obj2 instanceof String)
            try {
                return (obj1 == null ? "" : obj1.toString()) + (obj2 == null ? "" : obj2.toString());
            } catch (Exception e) {
                return null;
            }
    ...
    private static Object getValueBinaryCompareOp(Object aRoot, Object anObj, RMKeyChain aKeyChain)
    {
        ...
        switch (aKeyChain.getOp()) {
            case GreaterThan:
                return RMSort.Compare(o1, o2) == RMSort.ORDER_DESCEND;
            case LessThan:
                return RMSort.Compare(o1, o2) == RMSort.ORDER_ASCEND;
            case Equal:
                return RMSort.Compare(o1, o2) == RMSort.ORDER_SAME;
            case NotEqual:
                return RMSort.Compare(o1, o2) != RMSort.ORDER_SAME;
            case GreaterThanOrEqual:
                return RMSort.Compare(o1, o2) != RMSort.ORDER_ASCEND;
            case LessThanOrEqual:
                return RMSort.Compare(o1, o2) != RMSort.ORDER_DESCEND;
            default:
                throw new RuntimeException("RMKeyChain.getValueBinaryCompareOp: Not a compare op.");
        }
    }
    ...
    private static Object getValueChain(Object aRoot, Object anObj, RMKeyChain aKeyChain)
    {
        ...
        for (int i = 0, iMax = aKeyChain.getChildCount(); i < iMax; i++) {
            RMKeyChain child = aKeyChain.getChildKeyChain(i);
    ...
    {
        return KeyChain.getAndResetError();
    }
    ...
    public String toString()
    {
        ...
        Op op = getOp();
        if (op == Op.Key || op == Op.Literal) return getValueString();
        ...
        switch (op) {
            ...
            case Or:
                ...
                break;
            case ArrayIndex:
                sb.append(getChild(0)).append('[').append(getChild(1)).append(']');
                break;
            case FunctionCall:
                sb.append(getChild(0)).append('(').append(getChild(1)).append(')');
                break;
    ...
    {
        RMKeyChainFuncs.addFunctionClass(aClass);
    }
