...
public class RMKeyChainFuncs {
     ...
     */
    public static int indexOf(Object aStr, Object aPtrn)
    {
        return indexOf(aStr, aPtrn, 0);
    }
    ...
    public static String format(Object anObj, Object aStr)
    {
        ...
        String fmtStr = aStr instanceof String ? (String) aStr : null;
    ...
    public static String roman(Object anObj)
    {
        if (anObj instanceof Date) {
            ...
            c.setTime((Date) anObj);
            anObj = c.get(Calendar.YEAR);
        }
