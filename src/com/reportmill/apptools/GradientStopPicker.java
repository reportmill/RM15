...
public class GradientStopPicker extends ParentView {
    ...
    public void removeStop(int index)
    {
        ...
        if (getStopCount() == 2)
            throw new IndexOutOfBoundsException("GradientStopPicker: Cannot have fewer than 2 stops");
    ...
    protected void processEvent(ViewEvent anEvent)
    {
        ...
        if (anEvent.isMousePress()) {
            ...
            // Create and run the pop-up menu
                ...
                mitem.setText("Delete Color Stop");
    ...
    {
        if (aPC.getPropertyName() == ColorWell.Color_Prop) {
            ColorWell cwell = (ColorWell) aPC.getSource();
            int which = _wells.indexOf(cwell);
