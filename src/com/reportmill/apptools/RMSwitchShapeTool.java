...
public class RMSwitchShapeTool<T extends RMSwitchShape> extends RMParentShapeTool<T> {
    ...
    public void resetUI()
    {
        ...
        RMSwitchShape shape = getSelectedShape();
        if (shape == null) return;
        List<String> versions = getVersionNames();
    ...
    {
        RMSwitchShape s = getSelectedShape();
