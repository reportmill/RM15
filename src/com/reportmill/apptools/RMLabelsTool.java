...
public class RMLabelsTool extends RMTool implements RMSortPanel.Owner {
    ...
    public void respondUI(ViewEvent anEvent)
    {
        ...
        if (anEvent.equals("NumRowsText")) {
            labels.setNumberOfRows(anEvent.getIntValue());
            _selectedLabelFormat = null;
            labels.fixSize();
        }
        if (anEvent.equals("NumColumnsText")) {
            labels.setNumberOfColumns(anEvent.getIntValue());
            _selectedLabelFormat = null;
            labels.fixSize();
        }
        ...
        if (anEvent.equals("LabelWidthText")) {
            ...
            labels.getLabel().setWidth(f);
            _selectedLabelFormat = null;
            labels.fixSize();
        }
        if (anEvent.equals("LabelHeightText")) {
            double f = getPointsFromUnits(anEvent.getFloatValue());
            labels.getLabel().setHeight(f);
            _selectedLabelFormat = null;
            labels.fixSize();
        }
    ...
    {
        return (RMLabels) getSelectedShape();
    }
    ...
    {
        RMLabels labels = getLabels();
        return labels != null ? labels.getGrouping() : null;
    }
