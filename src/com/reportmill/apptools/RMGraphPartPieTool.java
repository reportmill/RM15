...
public class RMGraphPartPieTool extends RMTool {
    ...
    public void resetUI()
    {
        ...
        RMGraphPartPie pie = getSelectedShape();
        if (pie == null) return;
    ...
    public void respondUI(ViewEvent anEvent)
    {
        ...
        if (anEvent.equals("ExtrusionComboBox")) {
            ...
            if (pie.getExtrusionKey().equals(RMGraphPartPie.EXTRUDE_CUSTOM)) {
                DialogBox dbox = new DialogBox("Custom Extrusion Key Panel");
                dbox.setQuestionMessage("Extrusion Key:");
    ...
    {
        return "Graph Pie Wedge Inspector";
    }
