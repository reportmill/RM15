...
public class RMGraphTool<T extends RMGraph> extends RMTool<T> implements RMSortPanel.Owner {
    ...
    public void respondUI(ViewEvent anEvent)
    {
        ...
        if (anEvent.equals("ColorDock")) {
            ...
            while (colors.size() > 1 && colors.get(colors.size() - 1).equals(RMColor.white))
    ...
    private void titleViewExpandedChanged(ViewEvent anEvent)
    {
        ...
        TitleView tview = getView(name, TitleView.class);
        ...
        switch (name) {
            ...
            case "LabelAxisBox":
                ...
                break;
            case "SeriesBox":
                graph.setProxyShape(_seriesTool.getSelSeries());
                break;
            default:
                graph.setProxyShape(null);
                break;
